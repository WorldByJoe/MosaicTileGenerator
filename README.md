...
A browser-based generator for mid-century modern mosaic art — the warm palettes, blocky tile
fields and panel seams of 1950s and 60s decorative mosaic. It is a single self-contained HTML
file: no install, no build step, no internet connection required once loaded. Open it and it
runs.
